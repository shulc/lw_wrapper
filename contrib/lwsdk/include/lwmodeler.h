...
/* $wrapper: type=global, name=LWStateQueryFuncs$ */
typedef struct st_LWStateQueryFuncs
{
    ...
    /* $argument: method=LWStateQueryFuncs:bbox, arg2=out:double:6$ */
    ...
    /* $argument: method=LWStateQueryFuncs:vmap, arg2=out:unsigned int:$ */
...
/* $wrapper: type=global, name=LWFontListFuncs$ */
