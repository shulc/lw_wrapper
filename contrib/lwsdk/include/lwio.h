...
/* $comment: ------------------------------------------------------------------- */
/* $comment: All data members of LWSaveState need to be const'd to disable       */
/* $comment: destruction updating.  The global LWSaveState instance may have     */
/* $comment: been released by a call to closeSave(), causing writing into        */
/* $comment: random memory and likely heap corruption. (LWB-2846)                */
/* $comment: ------------------------------------------------------------------- */

/* $wrapper: type=access, name=LWSaveState$ */
typedef struct st_LWSaveState {
    /* $modifier: class=LWSaveState, arg=ioMode, modifier=const$ */
    int           ioMode;
    /* $modifier: class=LWSaveState, arg=writeData, modifier=const, apply=pointer$ */
    void         *writeData;
...
/* $comment: ------------------------------------------------------------------- */
/* $comment: All data members of LWLoadState need to be const'd to disable       */
/* $comment: destruction updating.  The global LWLoadState instance may have     */
/* $comment: been released by a call to closeLoad(), causing writing into        */
/* $comment: random memory and likely heap corruption. (LWB-2846)                */
/* $comment: ------------------------------------------------------------------- */

/* $wrapper: type=access, name=LWLoadState$ */
typedef struct st_LWLoadState {
    /* $modifier: class=LWLoadState, arg=ioMode, modifier=const$ */
    int       ioMode;
    /* $modifier: class=LWLoadState, arg=readData, modifier=const, apply=pointer$ */
    void     *readData;
...
/* $wrapper: type=global, name=LWFileIOFuncs$ */
