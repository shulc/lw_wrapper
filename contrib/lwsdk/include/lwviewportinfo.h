...
#define LWVIEWPORTINFO_GLOBAL "LW Viewport Info 9"
...
/* $wrapper: type=global, name=LWViewportInfo$ */
typedef struct st_LWViewportInfo
{
    ...
    /// @return The flags associated with the nth viewport (ex: LWVIEWF_HEADLIGHT).
    unsigned int (*flags)(int n);

    /// Fills 'spot' with the viewing position of the nth viewport.
    /* $argument: method=LWViewportInfo:pos, arg2=out::$ */
    ...
    /* $argument: method=LWViewportInfo:xfrm, arg2=out:double:9$ */
    void (*xfrm)(int n, double mat[9]);

    /// Fills 'hither' and 'yon' with the near and far Z clipping distances for 
    /// the nth viewport. 
    /* $argument: method=LWViewportInfo:clip, arg2=out:double:, arg3=out:double:$ */
    void (*clip)(int n, double* hither, double* yon);

    /// Fills 'left', 'top', 'width' and 'height' with pixel coordinates of the
    /// nth viewport. 
    /* $argument: method=LWViewportInfo:rect, arg2=out:int:, arg3=out:int:, arg4=out:int:, arg5=out:int:$ */
    ...
    /// be inverted.
    /* $argument: method=LWViewportInfo:projection, arg2=out::, arg3=out::$ */
    ...
    /// usually means that an inverse matrix was asked for for a matrix that could not 
    /// be inverted.
    /* $argument: method=LWViewportInfo:modelview, arg2=out::, arg3=out::$ */
    ...
    /// of the viewport. 
    /* $argument: method=LWViewportInfo:project, arg3=out:double:, arg4=out:double:, arg5=out:double:$ */
    ...
    /* $argument: method=LWViewportInfo:unproject, arg5=out::$ */
    ...
    /* $argument: method=LWViewportInfo:hoverIndex, arg1=out:double:2$ */
    ...
    /// @returns the current active preview viewport.
    int   (*getActivePreview)();

    // Get the backing store scalar for the nth viewport.  1.0 is normal.
    // This is usually > 1.0 when the view port is on a HiDPI display.
    float (*getBackingScale)(int n);
