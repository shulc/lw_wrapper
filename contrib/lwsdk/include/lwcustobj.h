...
#define LWCUSTOMOBJ_VERSION 8

/* $wrapper: type=access, name=LWCustomObjAccess$ */
typedef struct st_LWCustomObjAccess
{
    ...
    void        (*text)         (void *, double[3], LWCStringUTF8 text, int just, int csys);
    ...
    /* $argument: method=LWCustomObjAccess:measureText, arg3=out:int:, arg4=out:int:, arg5=out:int:$ */
    int         (*measureText)  (void *, LWCStringUTF8 text, int *width, int *height, int *offset_y);
    ...
    /* $argument: method=LWCustomObjAccess:getColor, arg3=out:float:4$ */
    void        (*getColor)     (void *, unsigned int index, float rgba[4]);
    void        (*pushMatrix)   (void *, LWDMatrix4 mat);
    void        (*popMatrix)    (void *);
    void        (*lineStrip)    (void *, unsigned int numv, double[][3], int csys);
    void        (*lineLoop)     (void *, unsigned int numv, double[][3], int csys);
...
/* $wrapper: type=handler, name=LWCustomObjHandler, context=LWItemID, accessor=LWCUSTOMOBJ$ */
