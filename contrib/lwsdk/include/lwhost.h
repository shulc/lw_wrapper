 ...
 */
#define LWFILEREQFUNC_GLOBAL "File Request" // (deprecated)

typedef int LWFileReqFunc ( LWCStringANSI hail, LWMutableCStringANSI name, LWMutableCStringANSI path, LWMutableCStringANSI fullName, int buflen );
 ...
 */
#define LWFILEACTIVATEFUNC_GLOBAL "File Request 3"
...
typedef LWCStringUTF8 LWFileTypeFunc (LWCStringASCII filetype);
 ...
 */
#define LWDIRINFOFUNC_GLOBAL "Directory Info 2"

typedef LWCStringUTF8 LWDirInfoFunc (LWCStringASCII filetype);
...
#define LWFTYPE_GRIDCACHE   "GridCache"

/****
 * Message Functions.  This block of functions is returned as the
 * "Info Messages 4" global service.  They display various info
 ...
 ****
 */
#define LWMESSAGEFUNCS_GLOBAL "Info Messages 4"

/* $wrapper: type=global, name=LWMessageFuncs$ */
typedef struct st_LWMessageFuncs
{
    void    (*info)     (LWCStringUTF8 line_a, LWCStringUTF8 line_b);
    void    (*error)    (LWCStringUTF8 line_a, LWCStringUTF8 line_b);
    void    (*warning)  (LWCStringUTF8 line_a, LWCStringUTF8 line_b);
    int     (*okCancel) (LWCStringUTF8 title, LWCStringUTF8 line_a, LWCStringUTF8 line_b);
    int     (*yesNo)    (LWCStringUTF8 title, LWCStringUTF8 line_a, LWCStringUTF8 line_b);
    int     (*yesNoCan) (LWCStringUTF8 title, LWCStringUTF8 line_a, LWCStringUTF8 line_b);
    int     (*yesNoAll) (LWCStringUTF8 title, LWCStringUTF8 line_a, LWCStringUTF8 line_b);
    LWCStringUTF8 (*askName) (LWCStringUTF8 title, LWCStringUTF8 label, LWCStringUTF8 initial_name);
} LWMessageFuncs;
