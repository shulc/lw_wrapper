...
typedef struct st_LWMicropol {
    ...
    /* $argument: method=LWMicropol:illuminate, arg3=out::, arg4=out::$ */
    LWIlluminateFunc *illuminate;
    /* $argument: method=LWMicropol:rayTrace, arg3=out::$ */
    LWRayTraceFunc   *rayTrace;
    LWRayCastFunc    *rayCast;
    /* $argument: method=LWMicropol:rayShade, arg3=out::$ */
    ...
    /* $argument: method=LWMicropol:rayTraceNearest, arg4=out:double:$ */
    LWRayNearestFunc *rayTraceNearest;
} LWMicropol;

typedef struct  st_LWTxtrParamDesc{
    LWCStringASCII  name;       // parameter name for gradient input POPUP
    ...
    LWCStringUTF8   itemName;   // item name if any
} LWTxtrParamDesc;
...
#define LWTEXTUREFUNCS_GLOBAL   "Texture Functions 6"

/* $wrapper: type=global, name=LWTextureFuncs$ */
typedef struct st_LWTextureFuncs {
    ...
    LWTextureID     (*create)(int returnType,LWCStringUTF8 name,LWTxtrContextID gc,void *userData);
    void            (*destroy)(LWTextureID txtr);
    /* $rename: class=LWTextureFuncs, method=copy, arg=from, name=fromtxtr$ */
    ...
    /* $argument: method=LWTextureFuncs:evaluate, arg3=out:double:$ */
    ...
    /* $argument: method=LWTextureFuncs:layerEvaluate, arg3=out:double:$ */
    ...
    /* $argument: method=LWTextureFuncs:evaluateUV, arg6=out:double:2$ */
    ...
    LWCStringUTF8   (*name)(LWTextureID txtr);
