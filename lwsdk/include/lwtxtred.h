...
#define     LWTXTREDFUNCS_GLOBAL    "Texture Editor 3"
...
/* $wrapper: type=global, name=LWTxtrEdFuncs$ */
typedef struct  st_LWTxtrEdFuncs {
    LWTECltID       (*subscribe)(LWCStringUTF8 title, int flags, void *userData, LW_TxtrRemoveFunc *, LW_TxtrAutoSizeFunc *,LW_TxtrEventFunc *);
    void            (*unsubscribe)(LWTECltID);

    void            (*open)(LWTECltID, LWTextureID, LWCStringUTF8 title);
    void            (*setTexture)(LWTECltID, LWTextureID, LWCStringUTF8 title);
