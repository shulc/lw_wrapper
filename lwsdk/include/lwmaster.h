...
#define LWMASTER_VERSION 5


/* $wrapper: type=access, name=LWMasterAccess$ */
...
/**
indicates the end of processing a frame
*/
#define LWEVNT_NOTIFY_NEWTIME_START 0x135
#define LWEVNT_NOTIFY_NEWTIME_END 0x136
/**
indicates items just loaded from scene
*/
#define LWEVNT_NOTIFY_LOAD_ITEMS_FROM_SCENE 0x137
/**
indicates light settings are being altered such that the resulting
light will different.
*/
#define LWEVNT_NOTIFY_LIGHT_ALTERED 0x138

/**
indicates initialization phase of newTime (ref:LWB-2985)
*/
#define LWEVNT_NOTIFY_NEWTIME_PREP 0x139
...
{
    LWCStringASCII classname;
    LWCStringASCII servername;
...
/* $wrapper: type=handler, name=LWMasterHandler$ */
