...
#define LWHUMANINTERFACE_HID_VERSION 2

typedef void *LWHumanInterfaceHIDID;

typedef struct st_LWHumanInterfaceHIDCreateContext
{
    LWHumanInterfaceHIDID in_hid;
    unsigned int vendor_id;
    unsigned int product_id;
    LWCStringUTF8 manufacturer_name;
    LWCStringUTF8 product_name;
    LWCStringUTF8 transport_name;
    LWCStringUTF8 serial_string;
    char reserved[32];
} LWHumanInterfaceHIDCreateContext;
...
// HID access
typedef struct st_LWHumanInterfaceHIDAccess
{
...
} LWHumanInterfaceHIDAccess;

typedef struct st_LWHumanInterfaceHIDReceiveAccess
{
    unsigned int report_id;
    unsigned char *report_data;
    unsigned int report_length;
} LWHumanInterfaceHIDReceiveAccess;
...
typedef struct st_LWHumanInterfaceHIDHandler
{
    ...
    int (*signature)( LWInstance in_inst, LWMutableCStringUTF8 out_signature, unsigned int in_max_bytes);
} LWHumanInterfaceHIDHandler;
